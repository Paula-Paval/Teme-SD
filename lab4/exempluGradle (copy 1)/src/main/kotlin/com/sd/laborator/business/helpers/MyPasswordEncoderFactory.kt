...
class MyPasswordEncoderFactory {
    companion object{
        private var _encoders: Map<String, PasswordEncoder> =hashMapOf(
            ...
            "SHA-256" to MessageDigestPasswordEncoder("SHA-256"),"sha256" to StandardPasswordEncoder(),
        )
        fun getPasswordEncodings(): Set<String>{
            return _encoders.keys
        }
        fun getEncoder(encodingId: String): PasswordEncoder?{return _encoders[encodingId]
        }
    }
}
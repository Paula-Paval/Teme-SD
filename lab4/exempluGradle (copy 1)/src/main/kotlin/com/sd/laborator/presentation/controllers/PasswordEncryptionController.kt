...
class PasswordEncryptionController {
    ...
    @RequestMapping(value = ["/encrypt"], method = [RequestMethod.GET])fun encryptPassword(
    ...
    @RequestMapping(value = ["/match"], method = [RequestMethod.POST])fun matchPassword(@RequestBody matchModel: MatchPasswordModel):ResponseEntity<Any>
    {
